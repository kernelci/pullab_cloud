...
#
# Third run: run pgbench on the second (tip) kernel.
...
# Confirm the kernel actually changed after the reboot from run-02.
...
# Run pgbench for the tip kernel and record the benchmark CSV.
